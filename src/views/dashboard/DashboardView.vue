<template>
  <div class="space-y-6 relative grid gap-5 grid-cols-[1fr_40fr]">
    <div class="relative mainLeft">
    ...
    <div class="mainRught">
      ...
      <div
        v-if="authStore.hasPermission('analytics')"
...
import BurgerView from '@/components/common/BurgerView.vue'
